      ...
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8">
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 mb-4">
            By accessing and using Southern Jerks restaurant website and services, you agree to be bound by these terms and conditions.
          </p>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 mb-4">
            The information provided on this website is for informational purposes only. Southern Jerks makes no representations or warranties of any kind regarding the accuracy or completeness of the content.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700">
            In no event shall Southern Jerks be liable for any indirect, incidental, special, or consequential damages arising from your use of this website or services.
          </p>
        </section>
        ...
        <section className="border-t pt-8">
          ...
          <p className="text-gray-700">
            If you have any questions about these terms and policies, please contact us at support@southernjerks.com
          </p>
        </section>
      </div>
    </div>
