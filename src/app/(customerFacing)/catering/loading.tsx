  ...
  return (
    <div className="flex flex-col items-center md:w-[90vw] pt-20 p-2 space-y-16 animate-pulse">
      ...
      <section className="relative w-full  rounded-2xl p-4 flex flex-col md:flex-row items-center gap-10">
        <div className="md:w-1/2 h-64 md:h-96 rounded-2xl bg-stone-100" />

        <div className="md:w-1/2 space-y-4 w-full">
          <div className="h-10 md:h-14 w-3/4 bg-stone-100 rounded-lg" />
          <div className="h-5 w-full bg-stone-100 rounded-md" />
          <div className="h-5 w-5/6 bg-stone-100 rounded-md" />

          <div className="flex gap-4 mt-6">
            <div className="h-12 w-40 rounded-xl bg-stone-100" />
            <div className="h-12 w-32 rounded-xl bg-stone-100" />
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl w-full space-y-10 text-center">
        <div className="h-8 w-72 mx-auto bg-stone-100 rounded-lg" />
        ...
        <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-4">
          {Array.from({ length: 4 }).map((_, i) => (
            ...
            >
              <div className="h-5 w-2/3 bg-stone-100 rounded-md" />
      ...
      <section className="max-w-6xl w-full space-y-10 px-2">
        <div className="flex justify-between items-center">
          <div className="h-8 w-56 bg-stone-100 rounded-lg" />
